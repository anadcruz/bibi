 ...
 *    public class TelaCadastroLivro extends javax.swing.JFrame {
    ...
    static int idLivro = 12345;
    int i = 0;
    ControleCadastroLivro c = new ControleCadastroLivro();
    Livro[] vetor;
 ...
 *   public TelaCadastroLivro() {
        initComponents();
        jtf_idLivro.setText(idLivro + "");
        jtf_disponibilidade.setText("Disponivel");
    }
 ...
 *    @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jcBox_dispoSim = new javax.swing.JCheckBox();
        jcBox_dispoNao = new javax.swing.JCheckBox();
        ...
        jLabel12.setText("Disponível para empréstimo:");

        jcBox_dispoSim.setText("SIM");

        jcBox_dispoNao.setText("NÃO");
        jcBox_dispoNao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcBox_dispoNaoActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jcBox_dispoSim)
                                .addGap(18, 18, 18)
                                .addComponent(jcBox_dispoNao)))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(jtf_pdfDispo, javax.swing.GroupLayout.PREFERRED_SIZE, 494, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
    ...
    Integer idLivro = Integer.parseInt(jtf_idLivro.getText());
    String titulo = jtf_titulo.getText();
    String autor = jtf_autor.getText();
    String editora = jtf_editora.getText();
    String sinopse = jtf_sinopse.getText();
    String idioma = jtf_idioma.getText();
    Integer dataPublic = jtf_dataPublic.getText();
    Integer numPag = jtf_numPag.getText();
    Integer quantExemplares = jtf_quantExemplares.getText();
    String pdfDispo = jtf_pdfDispo.getText();
    ...
    if (titulo.equals ("")) {
        ...
        l.setIdioma(idioma);
        l.setDataPublic(dataPublic);
        l.setNumPag(numPag);
        l.setQuantExemplares(quantExemplares);
        
        String tit = jtf_titulo.getText();
        vetor = c.retornaVetor();
        for (int a = 0; a < vetor.length; a++){
            if( vetor[a] != null){
                if (vetor[a].getTitulo().equals(tit)){
                    JOptionPane.showMessageDialog(null, "Nomes iguais, não é possível cadastrar livro. ");
                }
            }
        }
        ControleCadastroLivro d = new ControleCadastroLivro();
        d.cadastrar(l);
        jtf_idLivro.setText(""));
        idLivro++;
        ...
        jtf_sinopse.setText("");
        jtf_idioma.setText("");
        jtf_dataPublic.setText("");
        jtf_numPag.setText("");
        jtf_quantExemplares.setText("");
        jtf_pdfDispo.setText("");
        Livro[] A = d.retornaVetor();
    ...
    private void jcBox_dispoNaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcBox_dispoNaoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jcBox_dispoNaoActionPerformed
 ...
 *        java.awt.EventQueue.invokeLater(new Runnable() {
    ...
    private javax.swing.JCheckBox jcBox_dispoNao;
    private javax.swing.JCheckBox jcBox_dispoSim;
